...
public class TenantData {
    ...
    public TenantData(String tenantUserName, String tenantMailID, String tenantContactNumber, String tenantNativeLanguage, String tenantBranch) {
    ...
    public String toString() {
        return "TenantData{" +
                ...
                ", tenantNativeLanguage='" + tenantNativeLanguage + '\'' +
